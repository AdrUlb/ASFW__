...
using ASFW.Extension.Audio.Players.Winmm;
using ASFW.Extension.Audio.Sources;
using static ASFW.Extension.Audio.Players.Winmm.Imports;
...
internal sealed unsafe class WinmmAudioPlayer : AudioPlayer
{
	...
	public WinmmAudioPlayer(IAudioSource source)
	{
		Source = source;
