...
using ASFW.Audio.PlayerBackends.ASound;
using ASFW.Audio.Sources;
using static ASFW.Audio.PlayerBackends.ASound.Imports;

namespace ASFW.Audio.PlayerBackends;

internal sealed unsafe class AlsaAudioPlayerBackend : AudioPlayerBackend
{
	...
	public AlsaAudioPlayerBackend(IAudioSource source)
	{
		Source = source;
	...
	~AlsaAudioPlayerBackend() => Dispose();
